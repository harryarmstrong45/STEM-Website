...
export default function page() {
  ...
  return (
    <div className="h-[calc(100vh-150px)] flex justify-center items-center">
      <form className="my-100 -mt-[80px] flex flex-col justify-center items-center" onSubmit={handleRegister}>
      <div className="text-4xl border-b-2 w-full pb-2">Create Account</div>
        ...
        />
        <button className={inputformatButton} type="submit">Register</button>
      </form>
    </div>
  );
}
